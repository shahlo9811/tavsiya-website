            ...
            <div class="col-lg-9 mx-auto">
                ...
                @if($relatedPosts->count() > 0)
                    <section class="related-posts">
                        <h2 class="section-title mb-4" data-aos="fade-up">Bog'liq postlar</h2>
                        <div class="row">
                            @foreach($relatedPosts as $relatedPost)
                                <div class="col-md-4" data-aos="fade-right" data-aos-delay="100">
                                    <img src="{{ $relatedPost->main_image }}" alt="related post"
                                         class="post-thumbnail d-flex h-50">
                                    <p class="post-category">Kategoriyalarni ko'rsatish</p>
                ...
                @auth()
                    <section class="comment-section">
                        <h2 class="section-title mb-5" data-aos="fade-up">Izoh qo'shish</h2>
                        <form action="{{ route('post.comments.store', $post->id) }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="form-group col-12" data-aos="fade-up">
                                    <label for="comment" class="sr-only">Izoh</label>
                            ...
                            <div class="row">
                                <div class="col-12" data-aos="fade-up">
                                    <input type="submit" value="Jo'natish" class="btn btn-warning">
                                </div>
                            </div>
                        </form> 
                    </section>
