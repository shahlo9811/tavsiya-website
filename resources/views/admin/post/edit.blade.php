    ...
    <form method="post" action="{{ route('admin.post.update', $post->id) }}" enctype="multipart/form-data">
        ...
        <div class="card-body pl-0">
            ...
            <div class="form-group w-50">
                <label for="exampleInputEmail1" class="form-label">oldindan ko'rish rasmi</label>
                <div class="w-50 mb-2">
            ...
            <div class="form-group w-50">
                <label for="exampleInputEmail1" class="form-label">Asosiy rasm</label>
                <div class="w-50 mb-2">
            ...
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    <label for="exampleInputEmail1" class="form-label">Tanlash</label>
        ...
        <input type="submit" class="btn btn-primary mt-4 mb-5" value="Post yangilash">
    </form>
@endsection
